    ...
    <section className="relative py-24 overflow-hidden border-t border-white/5">
      ...
      <div className="mx-auto max-w-6xl px-6 relative z-10">
        ...
        <motion.div
          ...
          className="bg-zinc-50 dark:bg-white/[0.02] border border-zinc-200 dark:border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl backdrop-blur-sm relative overflow-hidden"
        >
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start relative z-10">
            ...
            <div className="w-full lg:w-[320px] shrink-0 flex flex-col items-center lg:items-start text-center lg:text-left space-y-8">
              ...
              <div className="w-full pt-4">
                <Button href="/cv.pdf" className="w-full flex justify-center py-4 bg-zinc-100 dark:bg-[var(--surface)] text-zinc-900 dark:text-white hover:bg-[var(--accent)] hover:text-white border border-zinc-200 dark:border-white/10 shadow-lg group">
