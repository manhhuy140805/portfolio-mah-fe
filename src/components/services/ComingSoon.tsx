      ...
      <div className="relative z-10 max-w-3xl w-full flex flex-col items-center text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.03] border border-white/[0.08] backdrop-blur-md mb-8">
            ...
            <span className="text-sm font-medium text-gray-300 tracking-wide uppercase">Services & Collaboration</span>
          </div>
        </motion.div>
        ...
        >
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-indigo-200 to-white drop-shadow-sm">
            Coming Soon
          </span>
          <br />
        ...
        >
          <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/[0.05] shadow-[0_0_30px_-10px_rgba(47,47,228,0.2)] backdrop-blur-xl">
            <Code2 className="w-8 h-8 text-[var(--accent-cyan)]" />
          </div>
          <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/[0.05] shadow-[0_0_30px_-10px_rgba(22,46,147,0.2)] backdrop-blur-xl -translate-y-4">
            <Palette className="w-8 h-8 text-[var(--accent-cyan)]" />
          </div>
          <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/[0.05] shadow-[0_0_30px_-10px_rgba(77,184,255,0.2)] backdrop-blur-xl">
